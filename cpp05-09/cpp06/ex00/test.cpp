...
private:
    static void handleFloatSpecial(const std::string& literal) {
    ...
    static void handleDoubleSpecial(const std::string& literal) {
    ...
    static void handleInteger(const std::string& literal) {
...
// Example usage
int main() {
    ScalarConverter::convert("'a'");   // char conversion
    ScalarConverter::convert("42");     // int conversion
    ScalarConverter::convert("3.14f");  // float conversion
    ScalarConverter::convert("-4.2");   // double conversion
    ScalarConverter::convert("nanf");    // float special case
    ScalarConverter::convert("+inf");     // double special case
    return 0;
}
